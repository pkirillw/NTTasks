...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="{{url('/')}}/js/oldkanban.js"></script>
...
">{{count($pipeline['tasks'])}} задач</span>
    ...
    width: 25px;">
                                                ...
                                                <span class="inner-icon inner-icon-edit" style="display: none;"
                                                      data-toggle="tooltip"
                                                      data-placement="top" onclick="editTask({{$task['id']}})"
                                                      title="Изменить задачу">
                                                </span>
                                                <span class="inner-icon inner-icon-end" style="display: none;"
                                                      data-toggle="tooltip"
                                                      data-placement="top"
                                                      onclick="additionalInfo({{$task['amo_id']}})"
